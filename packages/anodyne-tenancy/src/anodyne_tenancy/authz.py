...
_VIEWER = {"models:read", "datasets:read", "video_providers:read"}
_MEMBER = _VIEWER | {"llm:invoke", "models:write", "datasets:write", "video_providers:write"}
_ADMIN = _MEMBER | {"models:delete", "users:read", "video_providers:delete"}
